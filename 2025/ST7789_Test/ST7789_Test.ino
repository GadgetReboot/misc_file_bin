/**************************************************************************
  ST7789 240x240 1.54" Display Test for ESP32-C3 Super Mini module

  Uses library: Adafruit ST7735 and ST7789

  Modified example taken from the Adafruit ST7789 library.
 **************************************************************************/
...
void setup(void) {
  ...
  // large block of text
  tft.fillScreen(ST77XX_BLACK);
  testdrawtext("This text will appear on the display.  There is a lot of text so it will wrap to multiple lines on the display.  For sure. No doubt. ", ST77XX_WHITE);
  delay(4000);
